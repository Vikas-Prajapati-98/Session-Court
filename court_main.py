...
class HighCourt:
    ...
    def reset_flags_after_inactivity(self):
        ...
        self.reset_timer = threading.Timer(60.0, self.reset_flags)
    ...
    def process_case_details(self, case_id, lang="pa", input_from_button=False):
        ...
        BASE_URL = "http://192.168.1.36:8000/cases"
        ...
        if case_details:
            ...
            self.speak_text(text="Case not found.", lang=lang)
    ...
    def listen(self, lang="pa"):
        ...
        with sr.Microphone() as source:
            try:
                ...
                self.speak_text(text=f"Error, Could not understand audio.", lang='en')
            except sr.RequestError as e:
                self.speak_text(text=f"Error, Could not request results; {e}", lang='en')
            except Exception as e:
                self.speak_text(text=f"Error, An error occurred: {e}", lang='en')
        ...
        with sr.Microphone() as source:
            ...
            try:
                ...
                if closest_match:
                    ...
                    self.speak_text(text=f"Invalid case type: {recognized_text}.", lang='en')
                    print(f"Invalid case type: {recognized_text}. Valid case types are: {list(self.case_types.keys())}")
                    return None

            except sr.UnknownValueError:
                self.speak_text(text="Sorry, I could not understand the audio.", lang='en')
            except sr.RequestError as e:
                self.speak_text(text=f"Could not request results from the speech recognition service; {e}", lang='en')
            except Exception as e:
                self.speak_text(text=f"An error occurred in listen_case_type: {e}", lang='en')
    ...
    def listen_case_number(self, lang='en'):
        ...
        with sr.Microphone() as source:
            ...
            try:
                ...
                self.speak_text(text="Could not request results from the speech recognition service; {e}", lang='en')
            except Exception as e:
                self.speak_text(text=f"An error occurred in listen_case_number: {e}", lang='en')
    ...
    def listen_case_year(self, lang='en'):
        ...
        with sr.Microphone() as source:
            ...
            try:
                ...
                self.speak_text(text=f"An error occurred: {e}", lang='en')

            return None

    def listen_case_id(self, lang='en'):
        self.on_action_performed()
        ...
        try:
            ...
            self.root.update()
            case_type = self.listen_case_type()
            if case_type:
                self.text_input.delete(0, ctk.END)
            ...
            self.subtitle_label.configure(text=f"Valid Case ID: {case_id}")
